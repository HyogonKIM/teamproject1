...
function abc(titName,pageno,category){
    ...
    $.ajax({
        ...
        url: `https://hg0209.herokuapp.com/http://apis.data.go.kr/1262000/CountrySafetyService/getCountrySafetyList?serviceKey=Cm6iVvqGBwjh2oznueJPtJ%2Bj2nbXtKNAP5V7ZTvwx2pnzBWlI2hFXHhkuWcOo76C6XJ6iz%2FBVrcJdrFSXsuOaQ%3D%3D&numOfRows=10pageNo=${pageno}&title=${titName}&content=${category}`,
        dataType:'xml',
        beforeSend:function(){
